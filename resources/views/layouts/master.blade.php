						...
						<div class="topbar-menu right-menu">
							<ul>
                                ...
                                @auth
                                    ...
                                    <li class="menu-item" ><a title="User Dashboard" href="{{url('dashboard')}}">User Dashboard</a></li>
                                    @else
                                    <li class="menu-item" ><a title="Admin Dashboard" href="{{url('admin/dashboard')}}">Admin Dashboard</a></li>
                                    @endif
                                @else
                                    <li class="menu-item" ><a title="Login" href="{{url('login')}}">Login</a></li>
                                    <li class="menu-item" ><a title="Register" href="{{url('register')}}">Register</a></li>
                                @endauth
							</ul>
						</div>
					</div>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="{{url('/')}}" class="link-to-home"><img src="{{asset('assets/images/laravel_logo.png')}}" alt="mercado"></a>
						</div>
						...
						<div class="wrap-icon right-section">
							...
							@auth
								@php 
									$cart = App\Models\Cart::where('user_id', Auth::user()->id)->orderBy('id', 'desc')->get();
							...
							<div class="wrap-icon-section minicart">
								<a  href="{{url('cart')}}" class="link-direction">
									...
									<div class="left-info">
										@auth
										<span class="index">{{$count}} items</span>
										@else
								...
								<div class="modal-body">
									<table>
										...
										<tbody>
											...
											<tr>
												<td>
													<img width="50px" height="50px" src='{{asset("storage/images/".$cart->product->image)}}' alt="">
												</td>
