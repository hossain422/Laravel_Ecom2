									...
									<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											<a href="{{url('shop_details', $product->id)}}" title="{{$product->title}}">
												<figure><img src='{{asset("storage/images/".$product->image)}}' width="800" height="800" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
											</a>
											<div class="group-flash">
			...
			<div class="wrap-show-advance-info-box style-1">
				...
				<br> <br>
					@foreach($category as $category)
						<a href="{{url('home_category', $category->id)}}" class="btn btn-primary tab-control-item">{{$category->cat_name}}</a>
					@endforeach
